...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'logistique-collecte',
        loadComponent: () => import('./features/collectes/pages/logistique-collecte/logistique-collecte')
        .then((m) => m.LogistiqueCollecteComponent)
          },
      {
         path: 'logistique-calendrier',
         loadComponent: () => import('./features/collectes/pages/logistique-calendrier/logistique-calendrier')
         .then((m) => m.LogistiqueCalendrierComponent)
      },
      {
        path: 'tournees',
        loadComponent: () => import('./features/tournees/pages/tournees/tournees').then((m) => m.TourneesComponent)
      },
      {
        path: 'profile',
        loadComponent: () => import('./shared/components/profile/profile').then((m) => m.SharedProfileComponent)
