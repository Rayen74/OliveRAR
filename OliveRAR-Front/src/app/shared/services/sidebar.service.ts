...
export class SidebarService {
  private readonly menuConfigs: Record<string, MenuItem[]> = {
    ...
    RESPONSABLE_LOGISTIQUE: [
      ...
      { link: '/responsable-logistique/logistique-collecte', label: 'Mes collectes', icon: 'event' },
      { link: '/responsable-logistique/logistique-calendrier', label: 'Calendrier', icon: 'calendar_month' },
