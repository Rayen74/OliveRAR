...
export class SidebarService {
  private readonly menuConfigs: Record<string, MenuItem[]> = {
    RESPONSABLE_COOPERATIVE: [
      ...
      { link: '/responsable/vergers', label: 'Vergers', icon: 'map' },
      ...
      { link: '/responsable/tournees/calendrier', label: 'Calendrier Tournees', icon: 'calendar_month' },
      { link: '/responsable/types-ressources', label: 'Types de ressources', icon: 'category' },
      { link: '/responsable/unites', label: 'Unites logistiques', icon: 'precision_manufacturing' },
      { link: '/responsable/activites', label: "Journal d'activite", icon: 'history_edu' },
    ...
    AGRICULTEUR: [
      ...
      { link: '/agriculteur/activites', label: 'Mes activites', icon: 'history_edu' },
    ...
    RESPONSABLE_LOGISTIQUE: [
      ...
      { link: '/responsable-logistique/unites', label: 'Unites', icon: 'precision_manufacturing' },
      { link: '/responsable-logistique/collectes', label: 'Collectes', icon: 'event' },
      { link: '/responsable-logistique/tournees', label: 'Tournees', icon: 'route' },
      { link: '/responsable-logistique/calendrier', label: 'Calendrier logistique', icon: 'calendar_month' },
      { link: '/responsable-logistique/activites', label: 'Mes activites', icon: 'history_edu' },
      { link: '/responsable-logistique/profile', label: 'Mon Profil', icon: 'person' }
    ],
    RESPONSABLE_CHEF_RECOLTE: [
      { link: '/chef-recolte/tours', label: 'Mes Tournees', icon: 'route' },
      { link: '/chef-recolte/activites', label: 'Mes activites', icon: 'history_edu' },
