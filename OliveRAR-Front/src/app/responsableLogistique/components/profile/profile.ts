...
import { ResLogSidebar } from '../res-log-sidebar/res-log-sidebar';
...
@Component({
  selector: 'app-responsableLogistique-profile',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule,ResLogSidebar],
  templateUrl: './profile.html'
})
export class ResponsablelogistiqueProfileComponent  implements OnInit {
